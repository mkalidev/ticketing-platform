      ...
      <div className="container-full py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1">
            ...
            <p className="text-sm text-[var(--text-secondary)] max-w-xs">
              The modern ticketing platform for unforgettable experiences. 
          ...
          {/* Product */}
          <div>
            <h4 className="text-overline text-[var(--text-muted)] mb-4">Product</h4>
          ...
          {/* For Organizers */}
          <div>
            <h4 className="text-overline text-[var(--text-muted)] mb-4">For Organizers</h4>
            <ul className="space-y-3">
              <FooterLink href="/create-event">Create Event</FooterLink>
              <FooterLink href="/organizer-tools">Organizer Tools</FooterLink>
          ...
          {/* Company */}
          <div>
            <h4 className="text-overline text-[var(--text-muted)] mb-4">Company</h4>
            <ul className="space-y-3">
          ...
          {/* Legal */}
          <div>
            <h4 className="text-overline text-[var(--text-muted)] mb-4">Legal</h4>
            <ul className="space-y-3">
        ...
        <div className="mt-12 pt-8 border-t border-[var(--border-subtle)] flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-[var(--text-muted)]">
            © {currentYear} Tixly. All rights reserved.
          </p>
